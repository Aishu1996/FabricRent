...
<body>
	...
	<div class="main">
      ...
      <option href="#">Home</option>
		...
		<center>
		<div class="grid">
			 <h2 style="font-size: 30px">Register Here</h2>
    <br>
    <form action="./regi.php" method="post">
    <b  style="font-size: 20px">Username:&nbsp;&nbsp;</b><input type="text" name="username" required/></br><br>
    <b style="font-size: 20px">Password:&nbsp;&nbsp;</b><input type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required/></br><br>
    <b style="font-size: 20px">Phone:&nbsp;&nbsp;</b><input type="tel" name="phone" pattern="^\d{10}$" title="Please provide 10 digits" required/></br><br>
    <b style="font-size: 20px">Email:&nbsp;&nbsp;</b><input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required/></br><br><br>
